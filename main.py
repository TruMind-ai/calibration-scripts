...
suffix = "For the output to this prompt, only output an integer from 1-90 representing the stage and step/sub-step the experts have decided on. What is the rating (1-90)?"
