...
suffix = "END OF SAMPLE. Output an integer from 1-90 representing the stage and step/sub-step the experts have decided on. Only output the integer (1-90), do not output anything else."
